package com.distribike.features.subfeatures.form.main.forms.clutchform
...
@AndroidEntryPoint
class ClutchFormActivity : ComponentActivity() {

    companion object {
        fun newInstance(context: Context) = Intent(context, ClutchFormActivity::class.java)
    }

    private val viewModel: ClutchFormViewModel by viewModels()
            ...
            Column {
                ...
                if (data.value.sections.isNotEmpty()) {
                    Text(
                        ...
                        text = data.value.sections[9].title,
                        style = TextStyle(
                    ...
                    val steps = List(
                        data.value.sections[9].tasks.size
                    ) { index ->
                        Step(
                            title = data.value.sections[9].tasks[index].title
                        ) {
                            Row {
                                WorkerLottie(
                                    modifier = Modifier
                    ...
                    Stepper(
                        ...
                        completeFormButton = {
                            ...
                            Button(
                                ...
                                onClick = {
                                    finish()
                                    startActivity(OthersFormActivity.newInstance(context = applicationContext))
                                }) {
                                Text(
