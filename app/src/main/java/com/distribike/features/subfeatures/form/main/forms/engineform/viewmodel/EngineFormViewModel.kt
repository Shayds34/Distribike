package com.distribike.features.subfeatures.form.main.forms.engineform.viewmodel
...
@HiltViewModel
class EngineFormViewModel @Inject constructor(
    ...
    val shouldEnableNextButton = useCase.isEngineFormCompleted.asLiveData()
