package com.distribike.features.subfeatures.form.main.forms.steeringform.viewmodel
...
@HiltViewModel
class SteeringFormViewModel @Inject constructor(
    ...
    val shouldEnableNextButton = useCase.isSteeringFormCompleted.asLiveData()
