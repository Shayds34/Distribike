package com.distribike.features.subfeatures.form.main.forms.electricform.viewmodel
...
@HiltViewModel
class ElectricSystemFormViewModel @Inject constructor(
    ...
    val shouldEnableNextButton = useCase.isElectricSystemFormCompleted.asLiveData()
    ...
    fun saveCurrentStepState(
        ...
        viewModelScope.launch(dispatcher) {
            useCase.saveElectricSystemStepState(
                state = state,
