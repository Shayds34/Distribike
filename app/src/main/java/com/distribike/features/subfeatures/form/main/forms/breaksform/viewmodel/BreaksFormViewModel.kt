package com.distribike.features.subfeatures.form.main.forms.breaksform.viewmodel
...
@HiltViewModel
class BreaksFormViewModel @Inject constructor(
    ...
    val shouldEnableNextButton = useCase.isBreaksFormCompleted.asLiveData()
