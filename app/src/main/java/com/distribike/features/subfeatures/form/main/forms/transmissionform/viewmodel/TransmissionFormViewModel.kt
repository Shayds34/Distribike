package com.distribike.features.subfeatures.form.main.forms.transmissionform.viewmodel
...
@HiltViewModel
class TransmissionFormViewModel @Inject constructor(
    ...
    val shouldEnableNextButton = useCase.isTransmissionFormCompleted.asLiveData()
