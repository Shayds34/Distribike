package com.distribike.features.subfeatures.form.main.forms.clutchform.viewmodel
...
@HiltViewModel
class ClutchFormViewModel @Inject constructor(
    ...
    val shouldEnableNextButton = useCase.isClutchFormCompleted.asLiveData()
