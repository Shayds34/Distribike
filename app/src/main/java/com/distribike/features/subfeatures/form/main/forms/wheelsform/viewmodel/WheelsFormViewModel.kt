package com.distribike.features.subfeatures.form.main.forms.wheelsform.viewmodel
...
@HiltViewModel
class WheelsFormViewModel @Inject constructor(
    ...
    val shouldEnableNextButton = useCase.isWheelsAndTiresFormCompleted.asLiveData()
