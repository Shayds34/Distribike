package com.distribike.features.subfeatures.form.main.forms.suspensionsform
...
@AndroidEntryPoint
class SuspensionsFormActivity : ComponentActivity() {

    companion object {
        fun newInstance(context: Context) = Intent(context, SuspensionsFormActivity::class.java)
    }
            ...
            Column {
                ...
                if (data.value.sections.isNotEmpty()) {
                    Text(
                        ...
                        text = data.value.sections[4].title,
                        style = TextStyle(
                    ...
                    val steps = List(
                        data.value.sections[4].tasks.size
                    ) { index ->
                        Step(
                            title = data.value.sections[4].tasks[index].title
                        ) {
                            Row {
                                WorkerLottie(
                                    modifier = Modifier
