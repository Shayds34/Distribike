package com.distribike.features.subfeatures.form.main.forms.coolingform.viewmodel
...
@HiltViewModel
class CoolingFormViewModel @Inject constructor(
    ...
    val shouldEnableNextButton = useCase.isCoolingSystemFormCompleted.asLiveData()
    ...
    fun saveCurrentStepState(
        ...
        viewModelScope.launch(dispatcher) {
            useCase.saveCoolingSystemStepState(
                state = state,
