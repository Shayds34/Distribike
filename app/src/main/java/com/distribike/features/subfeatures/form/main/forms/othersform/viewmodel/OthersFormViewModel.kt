package com.distribike.features.subfeatures.form.main.forms.othersform.viewmodel
...
@HiltViewModel
class OthersFormViewModel @Inject constructor(
    ...
    val shouldEnableNextButton = useCase.isOtherFormCompleted.asLiveData()
