package com.distribike.features.subfeatures.form.main.forms.suspensionsform.viewmodel
...
@HiltViewModel
class SuspensionsFormViewModel @Inject constructor(
    ...
    val shouldEnableNextButton = useCase.isSuspensionFormCompleted.asLiveData()
